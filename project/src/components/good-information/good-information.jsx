...
export default function GoodInformation() {
  return (
    <div className="good-information">
      ...
      <dl className="good-information__main-features main-features">
      ...
      <div className="good-information__price">
        <span className="good-information__new-price">2 300 000 ₽</span>
        <span className="good-information__old-price">2 400 000 ₽</span>
      </div>
